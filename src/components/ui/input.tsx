	...
	return (
		<input
			...
			className={cn(
				...
				['button', 'submit', 'reset', 'checkbox', 'radio', 'range', 'color', 'file'].includes(type ?? 'text')
					? 'enabled:cursor-pointer'
					: 'enabled:cursor-text',
				'[&:enabled:not([readonly])::-webkit-calendar-picker-indicator]:cursor-pointer [&:enabled:not([readonly])::-webkit-inner-spin-button]:cursor-pointer',
